...
const $$TextContainer = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<article${addAttribute([
    ...
    "[&_p]:font-roboto [&_p]:mb-4 [&_p]:text-lg [&_p]:text-justify [&_p_strong]:text-amatista",
...
class ProductCard extends Component {
  render() {
    ...
    return /* @__PURE__ */ jsxs("a", { href, className: "inline-block group", children: [
  ...
  render() {
    ...
    return /* @__PURE__ */ jsx("div", { className: "overflow-x-scroll whitespace-nowrap lg:whitespace-normal lg:overflow-x-auto lg:flex lg:justify-center", children: /* @__PURE__ */ jsxs("div", { className: "flex gap-4 w-fit py-4 lg:py-0", children: [
      ...
      Object.values(ProductTag).map(
        (filter) => /* @__PURE__ */ jsx(FilterButton, { filter, activeFilter, setFilter: this.setActiveFilter }, filter)
      ),
      /* @__PURE__ */ jsx("span", { className: "lg:hidden", children: "<" })
    ] }) });
  }
...
class Shop extends Component {
  ...
  componentDidMount() {
    ...
    fetchProducts().then((data) => data.productos).then(
  ...
  render() {
    ...
    return /* @__PURE__ */ jsx("div", { className: "min-h-screen", children: /* @__PURE__ */ jsxs("div", { className: " mx-auto md:max-w-6xl", children: [
      ...
      !loading && /* @__PURE__ */ jsx(ProductList, { products: this.filterProducts() })
    ] }) });
  }
}
...
class ImageSlider extends Component {
  render() {
    ...
    return /* @__PURE__ */ jsxs("div", { className: "relative overflow-y-hidden col-span-2", children: [
      /* @__PURE__ */ jsx(
        "div",
        {
          style: { scrollbarWidth: "none" },
          className: "max-h-[650px] flex snap-x snap-mandatory overflow-x-auto scroll-smooth",
          children: images.map(({ src, alt, id }) => /* @__PURE__ */ jsx(
            "img",
            {
      ...
      /* @__PURE__ */ jsx("div", { className: "md:flex hidden mt-4 justify-center gap-8", children: images.map(({ id }) => /* @__PURE__ */ jsx(
        "a",
        {
          href: `#${id}`,
...
class ProductPage extends Component {
  ...
  render() {
    ...
    if (!product)
      return /* @__PURE__ */ jsx("div", { children: "Producto No encontrado o ha sido eliminado." });
...
export { $$SectionContainer as $, Shop as S, _id_ as _, $$Logo as a, $$TextContainer as b, $$Layout as c, formatCurreny as f };
