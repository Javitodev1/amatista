...
const $$Header = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const links = [
    ...
    { href: "/como-comprar", title: "C\xF3mo comprar" },
...
const $$Footer = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const socials = [
    {
      text: "Instagram",
      href: "https://www.instagram.com/amatista.comunidad/"
    },
    {
      text: "Whatsapp",
      href: "https://api.whatsapp.com/message/YSRW3CZPDBAED1?autoload=1&app_absent=0"
    },
    {
      text: "TikTok",
      href: "https://www.tiktok.com/@amatista.comunidad"
    },
    {
      text: "Facebook",
      href: "https://www.facebook.com/amatista.comunidad/"
    }
  ];
  const legals = [
    {
      text: "Pol\xEDtica de Privacidad",
      href: "/legales#politicas-de-privacidad"
    },
    {
      text: "Pol\xEDtica de Devoluciones y Reembolso",
      href: "/legales#politicas-de-reembolso"
    },
    {
  ...
  const sitemap = [
    ...
    {
      text: "Kit Sanaci\xF3n",
      href: "/kit-sanacion"
    },
    {
      text: "Nuestros empaques",
      href: "/empaques"
    },
    {
...
const $$Layout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const {
    ...
    description = "En amatista comunidad alargamos el ciclo de prendas \xFAnicas y sustentables como blusas, camisas, pantalones, vestidos, abrigos, poleras y accesorios. Enviamos a Maldonado, Montevideo, Canelones, Rocha y todo Uruguay."
  } = Astro2.props;
...
const $$SectionContainer = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<section${addAttribute(id, "id")}${addAttribute(["py-12", [
    className,
    { "bg-primary dark:bg-dark-primary": variant === "light" },
    { "bg-secondary dark:bg-dark-secondary": variant === "darker" }
...
const $$TextContainer = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<article${addAttribute([
    className,
    "[&_h2]:font-lora [&_h2]:mb-6 [&_h2]:text-4xl [&_h2]:md:text-left [&_h2]:text-center [&_h2]:uppercase [&_h2]:font-bold",
...
var ProductTag = /* @__PURE__ */ ((ProductTag2) => {
  ...
  ProductTag2["Shorts_y_Pantalones"] = "Shorts_Y_Pantalones";
  ProductTag2["Vestidos_y_Polleras"] = "Vestidos_Y_Polleras";
  ProductTag2["Accesorios_y_Calzado"] = "Accesorios_Y_Calzado";
  ProductTag2["Tejido_Artesanal"] = "Tejido_Artesanal";
  ProductTag2["Blusas_y_Camisas"] = "Blusas_Y_Camisas";
  return ProductTag2;
})(ProductTag || {});
...
function createCacheMemory(data, expireTimeInMinutes) {
  const createdAt = /* @__PURE__ */ new Date();
  const expireAt = (/* @__PURE__ */ new Date()).setMinutes(
...
async function catchFecthInMemory(fetchPromise, query, expireTimeInMinutes) {
...
const GET_PRODUCTS = (tag, cursor = null) => {
  ...
  return `
  {
    productosConnection(
      first: 20,
      ${!cursor ? "" : `after: "${cursor}",`}
      ${!tag || tag === ProductTag.Todo ? "" : `where: {tag_contains_some: ${category}},`}
    ) {
      edges {
        cursor
        node {
...
async function hygraphQuery({
  ...
  return catchFecthInMemory(
    new Promise((resolve, reject) => {
      ...
      }).then((json) => json.data).then((data) => resolve(data));
    }),
    query,
    expireTimeInMinutes
  );
...
async function fetchProductsByTag(tag, cursor) {
  return hygraphQuery({
    query: GET_PRODUCTS(tag, cursor)
  });
}
async function fetchLatestProducts(n = 8) {
  return hygraphQuery({
...
class ProductCard extends Component {
  ...
  render() {
    ...
    const priceFormatted = formatCurreny(price);
    ...
    return /* @__PURE__ */ jsxs(
      "a",
      {
        ...
        children: [
          /* @__PURE__ */ jsxs("div", { className: "relative mb-4 overflow-hidden", children: [
            /* @__PURE__ */ jsx(
              "img",
              {
                src: miniatura.url,
            ...
            isSoldout && /* @__PURE__ */ jsx("span", { className: "absolute px-3 py-1 text-sm rounded-full bottom-3 left-3 text-raw_white bg-midnight_green-900", children: "Agotado" })
          ] }),
          /* @__PURE__ */ jsx("h3", { className: "mb-2 font-semibold dark:text-white", children: title }),
          /* @__PURE__ */ jsx("p", { className: "dark:text-white", children: priceFormatted })
        ]
      }
    );
  }
...
class ProductList extends Component {
  render() {
    ...
    return /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 gap-2 md:grid-cols-4", children: products.map((product) => /* @__PURE__ */ jsx(ProductCard, { product }, product.id)) });
  }
}
...
class FilterButton extends Component {
  ...
  render() {
    ...
    const activeStyle = filter === activeFilter ? "text-amatista before:max-w-full" : "";
...
class FilterList extends Component {
  render() {
    ...
    return /* @__PURE__ */ jsx("div", { className: "overflow-x-scroll whitespace-nowrap lg:whitespace-normal lg:overflow-x-auto lg:flex lg:justify-center", children: /* @__PURE__ */ jsxs("div", { className: "flex gap-4 w-fit py-4 lg:py-0", children: [
      /* @__PURE__ */ jsx("span", { className: "lg:hidden", children: ">" }),
      Object.values(filters).map(({ tag, display }) => /* @__PURE__ */ jsx(
        FilterButton,
        {
          filter: tag,
          display,
...
const fetchProducts = (filter, cursor = null) => {
  return new Promise((resolve) => {
    fetchProductsByTag(filter, cursor).then((data) => data.productosConnection).then(({ edges, pageInfo }) => ({
...
class Shop extends Component {
  ...
  render() {
    ...
    return /* @__PURE__ */ jsx("div", { className: "min-h-screen", children: /* @__PURE__ */ jsxs("div", { className: " mx-auto md:max-w-6xl", children: [
      /* @__PURE__ */ jsx(
        FilterList,
        {
          filter,
      ...
      /* @__PURE__ */ jsx("hr", { className: "h-1 my-4 bg-gray-500 rounded-full opacity-20" }),
      loading && /* @__PURE__ */ jsx("p", { children: "cargando..." }),
      !loading && /* @__PURE__ */ jsx(ProductList, { products }),
      /* @__PURE__ */ jsx("div", { className: "flex justify-center", children: hasNextPage && /* @__PURE__ */ jsx(
        "button",
        {
...
class WspButton extends Component {
  render() {
    ...
    return /* @__PURE__ */ jsx(
      "a",
      {
        ...
        children: /* @__PURE__ */ jsxs("div", { className: "flex justify-center items-center gap-4", children: [
...
class ImageSlider extends Component {
  render() {
    ...
    if (!product.frontImg)
      return /* @__PURE__ */ jsx("div", { children: "Imagen de Producto 1 no cargada en el gestor de contenido" });
    if (!product.middleImg)
      return /* @__PURE__ */ jsx("div", { children: "Imagen Producto 2 no cargada en el gestor de contenido" });
    if (!product.backImg)
      return /* @__PURE__ */ jsx("div", { children: "Imagen Producto 3 no cargada en el gestor de contenido" });
    const images = [
      {
    ...
    return /* @__PURE__ */ jsxs("div", { className: "relative overflow-y-hidden", children: [
      /* @__PURE__ */ jsx(
        "div",
        {
          style: { scrollbarWidth: "none" },
          className: "max-w-[500px] flex snap-x snap-mandatory overflow-x-auto scroll-smooth",
          children: images.map(({ src, alt, key, id }) => /* @__PURE__ */ jsx(
            "img",
            {
      ...
      /* @__PURE__ */ jsx("div", { className: "md:flex hidden mt-4 justify-center gap-8", children: images.map(({ id }, index) => /* @__PURE__ */ jsx(
        "a",
        {
          href: `#${id}`,
...
class ProductPage extends Component {
  ...
  render() {
    ...
    if (loading)
      return /* @__PURE__ */ jsx("div", { children: "cargando..." });
    if (!product)
      return /* @__PURE__ */ jsx("div", { children: "Este producto ha encontrado un nuevo hogar" });
    ...
    return /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsxs("div", { className: "grid md:grid-cols-2 grid-cols-1", children: [
      /* @__PURE__ */ jsx(ImageSlider, { product }),
      /* @__PURE__ */ jsxs("div", { className: "md:p-12 px-6 mb-12 md:mb-0 md:order-last order-first", children: [
        /* @__PURE__ */ jsx("h2", { children: title }),
        tag.map((t) => /* @__PURE__ */ jsx("h3", { children: t.replace("_", " ") }, t)),
        ...
        /* @__PURE__ */ jsx(StockBadge, { stock }),
        /* @__PURE__ */ jsx(WspButton, { href: hrefWsp })
      ] })
    ] }) });
  }
}
...
class Latest extends Component {
  ...
  componentDidMount() {
    this.setState((prevState) => ({ ...prevState, loading: true }));
    fetchLatestProducts().then(({ productos }) => {
      this.setState((prevState) => ({
        ...prevState,
        loading: false,
        products: productos
  ...
  render() {
    ...
    if (loading)
      return /* @__PURE__ */ jsx("div", { children: "cargando..." });
    return /* @__PURE__ */ jsx(ProductList, { products });
  }
}
...
export { $$SectionContainer as $, Latest as L, ProductTag as P, Shop as S, _id_ as _, $$Logo as a, $$TextContainer as b, $$Layout as c, formatCurreny as f };
